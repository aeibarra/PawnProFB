...
type
  TfrmReport01 = class(TForm)
    ...
    clnLatePawncFullName: TStringField;
    clnLatePawnTransactionNo: TIntegerField;
    clnLatePawnTranTicketNo: TStringField;
    clnLatePawnCustno: TIntegerField;
    clnLatePawnCustLast: TStringField;
    clnLatePawnCustFirst: TStringField;
    clnLatePawnCustMid: TStringField;
    ...
    clnLatePawnCustPhBussiness: TStringField;
    ppLabel10: TppLabel;
