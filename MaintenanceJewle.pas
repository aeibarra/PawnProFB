...
type
  TfrmMaintenanceJ = class(TForm)
    ...
    qryStoneShapesJ_SHAPE: TWideStringField;
    qryStoneShapesJ_SHAPE_DESC: TWideStringField;
    qryStoneColors: TFDQuery;
    qryStoneColorsJ_STONE_COLOR: TWideStringField;
    qryStoneColorsJ_STONE_DESC: TWideStringField;
