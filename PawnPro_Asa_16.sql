...
-- Database file: C:\ProjectsGIT\PawnPro\DB\Kendalle\Pawn.db
-- Database CHAR collation: 1252LATIN1, NCHAR collation: UCA
-- Connection Character Set: windows-1252
--
-- CREATE DATABASE command: CREATE DATABASE 'C:\\ProjectsGIT\\PawnPro\\DB\\Kendalle\\Pawn.db' LOG ON 'C:\\ProjectsGIT\\PawnPro\\DB\\Kendalle\\Pawn.log' PAGE SIZE 8192 COLLATION '1252LATIN1(CaseSensitivity=Ignore)' NCHAR COLLATION 'UCA(CaseSensitivity=Ignore;AccentSensitivity=Ignore;PunctuationSensitivity=Primary)' ENCRYPTED ON KEY '?' ALGORITHM 'AES' BLANK PADDING OFF JCONNECT ON CHECKSUM ON
--
...
CREATE TABLE "DBA"."Store" (
   ...
   ,"InterestCalcMethod"             integer NULL DEFAULT 2
   ...
   ,"FTPpassive"                     bit NULL DEFAULT 1
   ,"PawnDateCalculationBase"        char(1) NULL DEFAULT 'D'
   ,"DefaultWeightMeasureUnit"       char(1) NULL
   ,"SalesTaxPerc"                   double NULL DEFAULT 7
   ,"DefaultPawnInterestRate"        double NULL
)
go
...
CREATE TABLE "DBA"."Stones" (
   ...
   ,"InvItemNo"                      integer NOT NULL
   ,"StoneNumber"                    integer NOT NULL
   ,"StoneShape"                     char(1) NOT NULL
   ,"StoneColor"                     char(1) NOT NULL
   ,"CT"                             double NOT NULL
   ,"WT"                             double NOT NULL
...
CREATE TABLE "DBA"."BackupSettings" (
   ...
   ,"BackupImagesPath"               varchar(255) NULL
   ,CONSTRAINT "ID" PRIMARY KEY ("BackupPath" ASC) 
)
go

CREATE TABLE "DBA"."ImagesDataBackup" (
    "ID"                             bigint NOT NULL
...
CREATE TABLE "DBA"."InventoryItemStatusLog" (
    "LogId"                          bigint NOT NULL DEFAULT autoincrement
   ,"InvItemNo"                      integer NOT NULL
   ,"OldStatus"                      char(1) NULL
   ,"NewStatus"                      char(1) NOT NULL
   ,"OldPawnedDate"                  date NULL
   ,"NewPawnedDate"                  date NULL
   ,"OldPurchaseDate"                date NULL
   ,"NewPurchaseDate"                date NULL
   ,"OldRedeemedDate"                date NULL
   ,"NewRedeemedDate"                date NULL
   ,"OldDefaultedDate"               date NULL
   ,"NewDefaultedDate"               date NULL
   ,"OldMeltedDate"                  date NULL
   ,"NewMeltedDate"                  date NULL
   ,"OldForSaleDate"                 date NULL
   ,"NewForSaleDate"                 date NULL
   ,"OldSoldDate"                    date NULL
   ,"NewSoldDate"                    date NULL
   ,"OldLayawayDate"                 date NULL
   ,"NewLayawayDate"                 date NULL
...
ALTER TABLE "DBA"."Stones"
    ADD NOT NULL FOREIGN KEY "InventoryItems" ("InvItemNo" ASC)
...
call sa_unload_display_table_status( 17738, 1, 31, 'DBA', 'States' )
go
...
call sa_unload_display_table_status( 17738, 2, 31, 'DBA', 'Store' )
go
...
call sa_unload_display_table_status( 17738, 3, 31, 'DBA', 'Stations' )
go
...
call sa_unload_display_table_status( 17738, 4, 31, 'DBA', 'SEQTable' )
go

call sa_unload_display_table_status( 17738, 5, 31, 'DBA', 'Customer' )
go
...
call sa_unload_display_table_status( 17738, 6, 31, 'DBA', 'Payments' )
go
...
call sa_unload_display_table_status( 17738, 7, 31, 'DBA', 'Transactions' )
go
...
call sa_unload_display_table_status( 17738, 8, 31, 'DBA', 'InvCategories' )
go

call sa_unload_display_table_status( 17738, 9, 31, 'DBA', 'InventoryItems' )
go
...
call sa_unload_display_table_status( 17738, 10, 31, 'DBA', 'JTypes' )
go

call sa_unload_display_table_status( 17738, 11, 31, 'DBA', 'JMetals' )
go

call sa_unload_display_table_status( 17738, 12, 31, 'DBA', 'JGenders' )
go

call sa_unload_display_table_status( 17738, 13, 31, 'DBA', 'JStyles' )
go

call sa_unload_display_table_status( 17738, 14, 31, 'DBA', 'JStoneShapes' )
go

call sa_unload_display_table_status( 17738, 15, 31, 'DBA', 'JStoneColors' )
go

call sa_unload_display_table_status( 17738, 16, 31, 'DBA', 'ItemStatus' )
go

call sa_unload_display_table_status( 17738, 17, 31, 'DBA', 'SalesItems' )
go

call sa_unload_display_table_status( 17738, 18, 31, 'DBA', 'Stones' )
go
...
call sa_unload_display_table_status( 17738, 19, 31, 'DBA', 'TableKeys' )
go

call sa_unload_display_table_status( 17738, 20, 31, 'DBA', 'TransactionTypes' )
go

call sa_unload_display_table_status( 17738, 21, 31, 'DBA', 'PaymentTypes' )
go
...
call sa_unload_display_table_status( 17738, 22, 31, 'DBA', 'BackupHistory' )
go

call sa_unload_display_table_status( 17738, 23, 31, 'DBA', 'ExportFormat' )
go

call sa_unload_display_table_status( 17738, 24, 31, 'DBA', 'ExportFileLog' )
go

call sa_unload_display_table_status( 17738, 25, 31, 'DBA', 'ExportLogFileDetail' )
go

CREATE INDEX "IDX_ExportLogFileDetail_Trano" ON "DBA"."ExportLogFileDetail"
    ( "TransactionNo" )
go

call sa_unload_display_table_status( 17738, 26, 31, 'DBA', 'ImagesTypes' )
go

call sa_unload_display_table_status( 17738, 27, 31, 'DBA', 'ImagesData' )
go

CREATE INDEX "IDX_ImagesData_ImagRefToRowNo" ON "DBA"."ImagesData"
    ( "ImagRefToRowNo" )
go

call sa_unload_display_table_status( 17738, 28, 31, 'DBA', 'BackupSettings' )
go

call sa_unload_display_table_status( 17738, 29, 31, 'DBA', 'ImagesDataBackup' )
go

CREATE UNIQUE INDEX "idx_ImagesDataNo" ON "DBA"."ImagesDataBackup"
    ( "ImagesDataNo" )
go

call sa_unload_display_table_status( 17738, 30, 31, 'DBA', 'InventoryItemStatusLog' )
go

CREATE INDEX "idx_InvStatusLog_Item" ON "DBA"."InventoryItemStatusLog"
    ( "InvItemNo","ChangedAt" DESC )
go

call sa_unload_display_table_status( 17738, 31, 31, 'DBA', 'GoldPriceHistory' )
go

CREATE INDEX "idx_GoldPrice_FetchDateTime" ON "DBA"."GoldPriceHistory"
    ( "FetchDateTime" DESC )
go
...
begin
  declare v_Result integer;
  set v_Result = (select LastKey from TableKeys where TableName = PTableName)+1;
  update TableKeys set LastKey = v_Result where TableName = PTableName;
  return(v_Result)
end
go
...
create procedure DBA.spi_GoldPrice( @PricePerOunce numeric(10,2),@Currency varchar(3) ) as begin declare @LastGPrice numeric(10,2) select top 1 @LastGPrice = PricePerOunce from GoldPriceHistory order by PriceID desc
  set @LastGPrice = isnull(@LastGPrice,0)
  if @LastGPrice <> @PricePerOunce insert into GoldPriceHistory( PricePerOunce,Currency,FetchDateTime,Source ) values( @PricePerOunce,@Currency,current timestamp,'CryptoCompare' ) 
...
create trigger DBA.trg_InvItems_StatusLog after update of InvItemStatus,PawnedDate,PurchaseDate,RedeemedDate,DefaultedDate,MeltedDate,ForSaleDate,SoldDate,LayawayDate on DBA.InventoryItems
referencing old as oldrow new as newrow
for each row begin if not oldrow.InvItemStatus is not distinct from newrow.InvItemStatus or not oldrow.PawnedDate is not distinct from newrow.PawnedDate or not oldrow.PurchaseDate is not distinct from newrow.PurchaseDate or not oldrow.RedeemedDate is not distinct from newrow.RedeemedDate or not oldrow.DefaultedDate is not distinct from newrow.DefaultedDate or not oldrow.MeltedDate is not distinct from newrow.MeltedDate or not oldrow.ForSaleDate is not distinct from newrow.ForSaleDate or not oldrow.SoldDate is not distinct from newrow.SoldDate or not oldrow.LayawayDate is not distinct from newrow.LayawayDate then insert into DBA.InventoryItemStatusLog( InvItemNo,OldStatus,NewStatus,OldPawnedDate,NewPawnedDate,OldPurchaseDate,NewPurchaseDate,OldRedeemedDate,NewRedeemedDate,OldDefaultedDate,NewDefaultedDate,OldMeltedDate,NewMeltedDate,OldForSaleDate,NewForSaleDate,OldSoldDate,NewSoldDate,OldLayawayDate,NewLayawayDate,ChangedBy ) values( newrow.InvItemNo,oldrow.InvItemStatus,newrow.InvItemStatus,oldrow.PawnedDate,newrow.PawnedDate,oldrow.PurchaseDate,newrow.PurchaseDate,oldrow.RedeemedDate,newrow.RedeemedDate,oldrow.DefaultedDate,newrow.DefaultedDate,oldrow.MeltedDate,newrow.MeltedDate,oldrow.ForSaleDate,newrow.ForSaleDate,oldrow.SoldDate,newrow.SoldDate,oldrow.LayawayDate,newrow.LayawayDate,current user ) end if
end
go
